import{r as n,j as e,L as a}from"./app-ep_muQEc.js";import{A as c}from"./AdminTabs-CGSMDVTV.js";import d from"./Profile-Cd5HZ_bB.js";import{A as m}from"./arrow-left-BzpM_sSu.js";import{P as i}from"./printer-D9c2Fumv.js";import{X as p}from"./x-BuxxqM04.js";import{F as x}from"./file-text-CmZnmbTu.js";import"./settings-xRKFsM24.js";import"./createLucideIcon-Bil6IiQP.js";import"./user-round-DJQSc9wh.js";import"./ship-Bl3LPNQj.js";import"./anchor-CWZ_gLZc.js";import"./mail-C5HxJzNc.js";import"./phone-C0nzq0kP.js";import"./upload-DxGexAI8.js";const f=[{key:"complete",title:"Complete Alpha Omega Application Form",description:"Personal data, documents, certificates, sea service, and deck officer experience."},{key:"zmi",title:"ZMI Application Form",description:"ZMI applicant details, certificates, offshore training, references, sea service, and deck experience."},{key:"flex_fleet",title:"Flex Fleet Application Form",description:"Flex Fleet personal particulars, documents, certificate courses, and sea service."},{key:"dynamic",title:"Dynamic Application Form",description:"Dynamic personal particulars, documents, certificate courses, and sea service."}];function b(t){return[t?.first_name,t?.middle_name,t?.last_name].filter(Boolean).join(" ")||t?.name||"Seafarer"}function T({client:t}){const l=b(t),[o,s]=n.useState(!1);return e.jsxs(c,{activeTab:"clients",title:"Seafarer Details",children:[e.jsx("style",{children:`
                .print-form-scroll {
